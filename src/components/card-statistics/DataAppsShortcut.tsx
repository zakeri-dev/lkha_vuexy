...
const DataAppsShortcut = (props: CardStatsHorizontalWithBorderProps) => {
  // Props
  const { title, stats, imageIcon, avatarIcon, color, url } = props
  ...
  return (
    <Link href={url}>
      <Card color={color || 'primary'} className='aspect-square rounded-full'>
        ...
        <Image src={imageIcon} alt='alt' width={100} height={100} unoptimized className='w-full h-full p-1' />
        {/* </CustomAvatar> */}
...
export default DataAppsShortcut
